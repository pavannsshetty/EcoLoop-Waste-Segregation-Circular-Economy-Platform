...
const Settings = () => {
  ...
  const title = dk('text-slate-200', 'text-slate-800');
  const sub = dk('text-slate-400', 'text-slate-500');
  const divider = dk('border-gray-800', 'border-slate-50');
  ...
  return (
    <div className="flex-1 px-4 sm:px-6 md:px-8 lg:px-10 pt-4 sm:pt-6 md:pt-8 lg:pt-10 pb-6 space-y-6 animate-in fade-in duration-500">
      <div>
        <h1 className={`text-lg font-bold tracking-tight ${title}`}>Portal Settings</h1>
